...
class line_tracing():
    ...
    def wrapping(self, image): #perspective transform
    ...
    def HSV_filter(self, image): #RGB - HSV

        cv2.cvtColor(image, cv2.COLOR_BGR2HSV)

        lower_lane = np.array([0, 105, 107]) #optimized for yellow line
    ...
    def callback(self, _data):
        ...
        w_f_img = self.HSV_filter(wrapped_img)
